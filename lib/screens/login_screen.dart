                      ...
                      children: [
                        ...
                        _buildTextField(
                          ...
                          validator: (value) {
                            ...
                            if (!value.trim().endsWith('@students.national-u.edu.ph')) {
  ...
  Future<void> _handleLogin() async {
    ...
    if (user == null) {
      ...
      IconSnackBar.show(
        ...
        label: 'User does not exist or network is unstable. Please try again.',
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              ...
              borderSide: const BorderSide(
                color: Color(0xFF2D3A8C), // Blue highlight
                width: 2,
              ),
            ),
          ),
