...
class _LocationScreenState extends State<LocationScreen> {
        ...
        return Dialog(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: const [
                CircularProgressIndicator(color: Color(0xFF2D3A8C)),
                SizedBox(height: 16),
                Text(
  ...
  Future<void> _getUserLocation() async {
    ...
    try {
      ...
      // 11.135376380746077, 124.55192934141948 house
      //11.13495786420349, 124.55304600729069  outside test
      ...
      //ilaka ernst 11.011526, 124.602494

      // FOR TESTING 14.838849, 121.042790

      //Office coordinates
      // const double officeLat = 14.838849;
      // const double officeLng = 121.042790;
          ...
          actions: [
            TextButton(
              onPressed: () async {
                ...
                await prefs.setBool('hasConfirmedTransaction', true);
