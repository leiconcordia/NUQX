                        ...
                        _buildTextField(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty)
                              return 'Required';
                            if (!value.endsWith("@students.national-u.edu.ph"))
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              var existingStudent =
                                  await MongoDatabase.getUserByStudentID(
                                    studentID,
                                  );
      ...
      child: Theme(
        data: Theme.of(context).copyWith(
          textSelectionTheme: const TextSelectionThemeData(
            cursorColor: Color(0xFF2D3A8C), // 🔹 Blue cursor
            selectionColor: Color(0x332D3A8C), // 🔹 Light blue highlight
            selectionHandleColor: Color(0xFF2D3A8C), // 🔹 Blue handles
          ),
        ),
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            contentPadding: EdgeInsets.symmetric(
              vertical: 12.5.h, // 🔹 Smaller vertical padding
              horizontal: 16.w,
            ),
            ...
            focusedBorder: OutlineInputBorder(
              ...
              borderSide: const BorderSide(
                color: Color(0xFF2D3A8C), // 🔹 Blue when focused
                width: 2,
              ),
            ),
          ),
      ...
      child: Theme(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: SizedBox(
              height: 20.h, // 🔹 Match field height
              child: IconButton(
                iconSize: 15.w,
                icon: Icon(
